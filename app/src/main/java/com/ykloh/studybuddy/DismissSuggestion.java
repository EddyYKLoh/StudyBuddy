 ...
 */
public class DismissSuggestion {
    private String sendPostRequest(HashMap<String, String> postDataParams) {
        URL url = null;
        String response = "";
        try {
            url = new URL("http://192.168.43.103/StudyBuddy/dismissSuggestion.php");
    ...
    public void submitDismiss(final Context context, final String postID, final Bundle bundle) {
        ...
        class dismiss extends AsyncTask<String, Void, String> {
        ...
        dismiss dm = new dismiss();
        dm.execute(postID, userID);
