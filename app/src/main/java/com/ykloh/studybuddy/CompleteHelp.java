...
public class CompleteHelp {
    private String sendPostRequest(HashMap<String, String> postDataParams) {
        ...
        String response = "";
        try {
            url = new URL("http://192.168.43.103/StudyBuddy/completeHelp.php");
    ...
    public void submitCompleteHelp(final Context context, final String postID, final Bundle bundle) {
        ...
        class completeHelp extends AsyncTask<String, Void, String> {
        ...
        completeHelp ch = new completeHelp();
