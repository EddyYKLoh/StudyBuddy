...
public class UIPickerSuggestedFilter {
    private String sendPostRequest(HashMap<String, String> postDataParams) {
    URL url = null;
    String response = "";
    try {
        url = new URL("http://192.168.43.103/StudyBuddy/matchResultIDListGetter.php");
    ...
    public void processUISelection (final Context context, final PublicPost publicPost, final String helperIDList) {
            ...
            protected void onPostExecute(String s) {
                ...
                if (s.equals("Couldn't connect to server.")) {
                    ...
                    if(s.equals("No result.")){
                        PublicPostViewerPicker publicPostViewerPicker = new PublicPostViewerPicker(publicPost, context, helperIDList, "");
                    }else{
                        PublicPostViewerPicker publicPostViewerPicker = new PublicPostViewerPicker(publicPost, context, helperIDList ,s);
                    }
